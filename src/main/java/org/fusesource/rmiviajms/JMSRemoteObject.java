...
public class JMSRemoteObject extends RemoteObject implements Serializable {
    ...
    /**
     * Same as {@link #export(Object, Class[], Destination)} but uses the
    ...
    public static Remote export(Object obj, Class<?>[] interfaces) throws Exception {
        return export(obj, interfaces, null);
    }
     ...
     *             If there is an error exporting the object
     */
    public static Remote export(Object obj, Class<?>[] interfaces, Destination destination) throws Exception {
    ...
    /**
     * Same as {@link #export(Object, Class[], Destination)}, where the

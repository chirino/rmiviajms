...
public final class SubProcess {
    ...
    public void tell(String str) throws IllegalStateException, IOException {
        if (dataOutput == null) {
            ...
            throw new IllegalStateException("Subprocess output stream control disabled");
        }
        tell(dataOutput, str);
    }
    ...
    public void expect(String str, boolean whole, boolean ignoreCase)
        ...
        if (dataInput == null) {
            ...
            throw new IllegalStateException("Subprocess input stream control disabled");
        }
    ...
    public void expectError(String str, boolean whole, boolean ignoreCase)
        ...
        if (dataError == null) {
            ...
            throw new IllegalStateException("Subprocess error stream control disabled");
        }
    ...
    private final class StreamPipe extends Thread {
        ...
        public void run() {
            try {
                ...
                assert (len == -1)
                        : ("read(byte[]) returned unexpected value: "+len); //$NON-NLS-1$
            } catch (IOException e) {
